...
- **Document registration — execution suffix:** optional «Исполнение» field before the document kind code; user enters digits (e.g. `1` → `-01`, `15` → `-15`) and the suffix is included in the designation.
